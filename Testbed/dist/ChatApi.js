...
define("Testbed/src/testing", ["require", "exports", "SEApi/src/SEApi"], function (require, exports, SEApi_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    debugger;
    var results = SEApi_1.GetCommentsOnAnswer([18804596]);
    results.then(function (r) { return console.log(r); });
});
